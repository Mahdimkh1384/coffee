...
export default function Footer() {
    return (
        <div className="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
            <div className="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
                ...
                <div className="col-lg-3 col-md-6 mb-5">
                    ...
                    <div className="d-flex justify-content-start">
                        <a className="btn btn-lg btn-outline-light btn-lg-square mr-2"><i className="fab fa-twitter"></i></a>
                        <a className="btn btn-lg btn-outline-light btn-lg-square mr-2"><i className="fab fa-facebook-f"></i></a>
                        <a className="btn btn-lg btn-outline-light btn-lg-square mr-2"><i className="fab fa-linkedin-in"></i></a>
                        <a className="btn btn-lg btn-outline-light btn-lg-square"><i className="fab fa-instagram"></i></a>
                    </div>
                </div>
                <div className="col-lg-3 col-md-6 mb-5">
            ...
            <div className="container-fluid text-center text-white border-top mt-4 py-4 px-sm-3 px-md-5" style={{ "border-color ": "rgba(256, 256, 256, .1)!important" }}>
